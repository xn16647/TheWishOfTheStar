 ...
 */
public class NoopsycheFragment extends BaseFragment implements StealContract.View{
    private StealContract.Presenter presenter;
    private ProgressDialog progressDialog;
    private RecyclerView recycler;
    private LinearLayout noopsyche_linear;
    ...
    protected void init() {
        ...
        noopsyche_linear = getView().findViewById(R.id.noopsyche_linear);
        if (isNetWorkAvaliable(getContext())){
            presenter = new StealPresenter(this);
            presenter.loadData(getContext());
            recycler.setVisibility(View.VISIBLE);
            noopsyche_linear.setVisibility(View.GONE);
        }else{
            recycler.setVisibility(View.GONE);
            noopsyche_linear.setVisibility(View.VISIBLE);
        }
    ...
    @Override
    public void showSteal(WokerMasterBean wokerMasterBean) {
        list.clear();
